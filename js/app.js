(() => {
    ...
    burger.addEventListener("click", (function(e) {
        document.querySelector(".menu__body,.menu__number").classList.toggle("active");
    ...
    if (isMobile.any()) {
        ...
        for (let link of links) link.addEventListener("click", (function(e) {
            document.querySelector(".menu__body,.menu__number").classList.remove("active");
